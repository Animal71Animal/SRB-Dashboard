...
export const ROLE_PERMISSIONS: Record<Role, Permissions> = {
  ...
  Manager: {
    view: ["/events", "/promotional-ideas", "/promo-campaigns", "/feature-shows", "/content-assets", "/influencers", "/influencers/tracking-dashboard", "/attendance", "/analytics", "/torch-radio", "/torchtv", "/staff-notes", "/dj-mc-communications", "/dj-mc-communications/schedules", "/dj-mc-communications/promotional-materials", "/dj-mc-communications/stage-announcement-ideas", "/dj-mc-communications/messaging", "/dj-mc-communications/equipment-reports", "/dj-mc-communications/passwords", "/dj-mc-communications/scheduling", "/director-admin", "/tv-routing"],
    edit: ["/events", "/torchtv"],
    special: ["admin-console", "director-admin"]
  },
  DJ: {
    view: ["/events", "/torchtv", "/torch-radio", "/influencers", "/influencers/tracking-dashboard", "/dj-mc-communications", "/dj-mc-communications/schedules", "/dj-mc-communications/promotional-materials", "/dj-mc-communications/stage-announcement-ideas", "/dj-mc-communications/messaging", "/dj-mc-communications/equipment-reports", "/dj-mc-communications/passwords", "/dj-mc-communications/scheduling", "/director-admin", "/tv-routing"],
    edit: ["/torchtv"],
    special: ["admin-console", "director-admin"]
  },
  Employee: {
    view: ["/events", "/torchtv", "/influencers", "/influencers/tracking-dashboard", "/tv-routing"],
    edit: [],
    special: ["admin-console", "director-admin"]
  },
};
